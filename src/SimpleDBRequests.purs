...
module AWS.SimpleDB.Requests where
...
import AWS.SimpleDB as SimpleDB
import AWS.SimpleDB.Types as SimpleDBTypes
...
batchDeleteAttributes :: forall eff. SimpleDB.Service -> SimpleDBTypes.BatchDeleteAttributesRequest -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
batchDeleteAttributes (SimpleDB.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "batchDeleteAttributes"
...
batchPutAttributes :: forall eff. SimpleDB.Service -> SimpleDBTypes.BatchPutAttributesRequest -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
batchPutAttributes (SimpleDB.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "batchPutAttributes"
...
createDomain :: forall eff. SimpleDB.Service -> SimpleDBTypes.CreateDomainRequest -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
createDomain (SimpleDB.Service serviceImpl) = AWS.request serviceImpl method  where
...
deleteAttributes :: forall eff. SimpleDB.Service -> SimpleDBTypes.DeleteAttributesRequest -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
deleteAttributes (SimpleDB.Service serviceImpl) = AWS.request serviceImpl method  where
...
deleteDomain :: forall eff. SimpleDB.Service -> SimpleDBTypes.DeleteDomainRequest -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
deleteDomain (SimpleDB.Service serviceImpl) = AWS.request serviceImpl method  where
...
domainMetadata :: forall eff. SimpleDB.Service -> SimpleDBTypes.DomainMetadataRequest -> Aff (exception :: EXCEPTION | eff) SimpleDBTypes.DomainMetadataResult
domainMetadata (SimpleDB.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "domainMetadata"
...
getAttributes :: forall eff. SimpleDB.Service -> SimpleDBTypes.GetAttributesRequest -> Aff (exception :: EXCEPTION | eff) SimpleDBTypes.GetAttributesResult
getAttributes (SimpleDB.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "getAttributes"
...
listDomains :: forall eff. SimpleDB.Service -> SimpleDBTypes.ListDomainsRequest -> Aff (exception :: EXCEPTION | eff) SimpleDBTypes.ListDomainsResult
listDomains (SimpleDB.Service serviceImpl) = AWS.request serviceImpl method  where
...
putAttributes :: forall eff. SimpleDB.Service -> SimpleDBTypes.PutAttributesRequest -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
putAttributes (SimpleDB.Service serviceImpl) = AWS.request serviceImpl method  where
...
select :: forall eff. SimpleDB.Service -> SimpleDBTypes.SelectRequest -> Aff (exception :: EXCEPTION | eff) SimpleDBTypes.SelectResult
select (SimpleDB.Service serviceImpl) = AWS.request serviceImpl method  where
    method = AWS.MethodName "select"
