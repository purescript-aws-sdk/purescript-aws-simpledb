...
batchDeleteAttributes :: forall eff. SimpleDB.Service -> SimpleDBTypes.BatchDeleteAttributesRequest -> Aff (exception :: EXCEPTION | eff) Unit
...
batchPutAttributes :: forall eff. SimpleDB.Service -> SimpleDBTypes.BatchPutAttributesRequest -> Aff (exception :: EXCEPTION | eff) Unit
...
createDomain :: forall eff. SimpleDB.Service -> SimpleDBTypes.CreateDomainRequest -> Aff (exception :: EXCEPTION | eff) Unit
...
deleteAttributes :: forall eff. SimpleDB.Service -> SimpleDBTypes.DeleteAttributesRequest -> Aff (exception :: EXCEPTION | eff) Unit
...
deleteDomain :: forall eff. SimpleDB.Service -> SimpleDBTypes.DeleteDomainRequest -> Aff (exception :: EXCEPTION | eff) Unit
...
putAttributes :: forall eff. SimpleDB.Service -> SimpleDBTypes.PutAttributesRequest -> Aff (exception :: EXCEPTION | eff) Unit
