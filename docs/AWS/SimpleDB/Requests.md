## Module AWS.SimpleDB.Requests

#### `batchDeleteAttributes`

``` purescript
batchDeleteAttributes :: forall eff. Service -> BatchDeleteAttributesRequest -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
batchPutAttributes :: forall eff. Service -> BatchPutAttributesRequest -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
createDomain :: forall eff. Service -> CreateDomainRequest -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
deleteAttributes :: forall eff. Service -> DeleteAttributesRequest -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
deleteDomain :: forall eff. Service -> DeleteDomainRequest -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
domainMetadata :: forall eff. Service -> DomainMetadataRequest -> Aff (exception :: EXCEPTION | eff) DomainMetadataResult
```
...
``` purescript
getAttributes :: forall eff. Service -> GetAttributesRequest -> Aff (exception :: EXCEPTION | eff) GetAttributesResult
```
...
``` purescript
listDomains :: forall eff. Service -> ListDomainsRequest -> Aff (exception :: EXCEPTION | eff) ListDomainsResult
```
...
``` purescript
putAttributes :: forall eff. Service -> PutAttributesRequest -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
select :: forall eff. Service -> SelectRequest -> Aff (exception :: EXCEPTION | eff) SelectResult
```
