...
``` purescript
batchDeleteAttributes :: forall eff. Service -> BatchDeleteAttributesRequest -> Aff (exception :: EXCEPTION | eff) Unit
```
...
``` purescript
batchPutAttributes :: forall eff. Service -> BatchPutAttributesRequest -> Aff (exception :: EXCEPTION | eff) Unit
```
...
``` purescript
createDomain :: forall eff. Service -> CreateDomainRequest -> Aff (exception :: EXCEPTION | eff) Unit
```
...
``` purescript
deleteAttributes :: forall eff. Service -> DeleteAttributesRequest -> Aff (exception :: EXCEPTION | eff) Unit
```
...
``` purescript
deleteDomain :: forall eff. Service -> DeleteDomainRequest -> Aff (exception :: EXCEPTION | eff) Unit
```
...
``` purescript
putAttributes :: forall eff. Service -> PutAttributesRequest -> Aff (exception :: EXCEPTION | eff) Unit
```
